...
public class SoloAwardDTO2 {
	...
	public String toString() {
		return "SoloAwardDTO2 [resu_code=" + resu_code + ", username=" + username + ", award_no=" + award_no
				+ ", award_name=" + award_name + ", award_co=" + award_co + ", award_year=" + award_year
