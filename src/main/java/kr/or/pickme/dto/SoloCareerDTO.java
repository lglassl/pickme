...
public class SoloCareerDTO {
	...
	public String toString() {
		return "SoloCareerDTO [username=" + username + ", career_no=" + career_no + ", career_institute="
				+ career_institute + ", career_start=" + career_start + ", career_end=" + career_end + ", career_task="
				+ career_task + ", career_activity=" + career_activity + "]";
	}
