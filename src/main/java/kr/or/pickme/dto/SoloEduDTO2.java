...
public class SoloEduDTO2 {
	...
	public String toString() {
		return "SoloEduDTO2 [resu_code=" + resu_code + ", username=" + username + ", edu_no=" + edu_no
				+ ", edu_institute=" + edu_institute + ", edu_start=" + edu_start + ", edu_end=" + edu_end
				+ ", edu_category=" + edu_category + ", edu_major=" + edu_major + ", edu_grade=" + edu_grade + "]";
	}
