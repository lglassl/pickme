...
public class SoloLangDTO {
	...
	public String toString() {
		return "SoloLangDTO [username=" + username + ", lang_no=" + lang_no + ", lang_field=" + lang_field
				+ ", lang_testname=" + lang_testname + ", lang_grade=" + lang_grade + ", lang_getdate=" + lang_getdate
				+ "]";
	}
