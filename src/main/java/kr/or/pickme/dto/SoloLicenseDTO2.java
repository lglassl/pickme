...
public class SoloLicenseDTO2 {
	...
	public String toString() {
		return "SoloLicenseDTO2 [resu_code=" + resu_code + ", username=" + username + ", license_no=" + license_no
				+ ", license_name=" + license_name + ", license_co=" + license_co + ", license_getdate="
				+ license_getdate + "]";
	}
