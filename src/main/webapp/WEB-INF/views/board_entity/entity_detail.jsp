   ...
   $(document).ready(function(){
       ...
       $("#reply_save").click(function(){
           ...
           var objParams = {
           		...
           		entity_code : ${entitydto.entity_code},
                   entity_parent       : "0",  
                   entity_re_depth    : "0",
                   username   : $("#reply_writer").val(),
                   entity_re_pwd  : $("#reply_password").val(),
                   entity_re_ctmt   : reply_content
           ...
           $.ajax({
               ...
               success     :   function(retVal){
                   ...
                   if(retVal.code != "OK") {
                       ...
                       reply_id = retVal.entity_re_code;
                       console.log("ajax 에서 id값 : " + reply_id);
                   }
       ...
       $("button[name='reply_del']").click(function(){//id값 바뀌기때문에 name값
           ...
           var objParams = {
                   entity_re_pwd  : $("#"+reply_password).val(),
                   entity_re_code        : reply_id,
                   entity_code     : ${entitydto.entity_code}
           };
            
           //ajax 호출
           $.ajax({
               url         :   "entity_re_delete.htm",
               dataType    :   "json",
               contentType :   "application/x-www-form-urlencoded; charset=UTF-8",
               type        :   "post",
           ...
           /*     	console.log(data);
   				...
   				$.each(data.list, function(index,obj){
   					...
   					opr += obj.entity_date +"</td></tr><tr><td colspan='2'>"+obj.entity_ctmt;
   					opr += "</td><td>";
       ...
       $(document).on("click","button[name='reply_reply_save']",function(){
           ...
           //값 셋팅
           var objParams = {
           		entity_code        : $("#board_id").val(),
           		entity_parent       : "1", 
           		entity_re_depth           : "1",
           		username    : reply_reply_writer.val(),
           		entity_re_pwd  : reply_reply_password.val(),
           		entity_re_ctmt   : reply_reply_content_val
           };
       ...
       $(document).on("click","button[name='reply_reply_cancel']",function(){
		...
		<div class="main_area">
            ...
            <div class="row">
                <div class="col-md-10">
                    <table class="table table-striped">
						...
						<tr>
							<th>작성일</th>
							<td><input type="text" value="${entitydto.entity_date}" readonly></td>
						</tr>
						<tr>
							<th>글쓴이</th>
							<td id="id">
						...
						<tr>
							<th>내용</th>
							<td><input type="text" value=" ${entitydto.entity_ctmt}" readonly></td>
						</tr>                        
                    </table>
                ...
                <c:forEach var="replyList" items="${replyList}" varStatus="status">
                    ...
                    <tr reply_type="<c:if test="${replyList.entity_re_depth == '0'}">main</c:if><c:if test="${replyList.entity_re_depth == '1'}">sub</c:if>"><!-- 댓글의 depth 표시 -->
                        <td width="870px">
                            <c:if test="${replyList.entity_re_depth == '1'}"> → </c:if>${replyList.entity_re_ctmt}
                        ...
                        <td width="100px">
                            <input type="password" id="reply_password_${replyList.entity_re_code}" style="width:100px;" maxlength="10" placeholder="패스워드"/>
                           
                        </td>
                        <td>
                            <button name="reply_del" reply_id = "${replyList.entity_re_code}">삭제</button>
                            <c:if test="${replyList.entity_re_depth != '1'}">
                                <button name="reply_reply" reply_id = "${replyList.entity_re_code}">댓글</button><!-- 첫 댓글에만 댓글이 추가 대댓글 불가 -->
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <table class="table table2">
                ...
                <tr>
                    <td>
                        <textarea style="width:100%" id="reply_content" name="reply_content" rows="4" placeholder="댓글을 입력하세요."></textarea>
                    </td>
                </tr>
            </table>
            
				<div style="text-align:center">
					<button type="button" id="list" class="btn btn-default" onclick="location.href='entity_list.htm'">목록</button>
