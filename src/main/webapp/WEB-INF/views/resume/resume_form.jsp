			...
			<div class="col-md-8">
				<div class="row">
					...
					<div style="text-align: center; margin-bottom: 40px;">		
						...
						<input type="button" class="btn btn-lg btn-primary" id="enrollResumeCancelBtn" value=" 되돌아가기 ">
					</div>
...
$(document).ready(function(){
	$('#enrollResumeBtn').click(function(){
		$("#resumeEnrollForm").attr("action", "resumeinsert.htm").submit();
	});

	
	$('#enrollResumeCancelBtn').click(function(){
