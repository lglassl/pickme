...
<div class="resumeContainer">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				<div class="row">
					<div class="col-lg-12" class="label" style="text-align: center"><h2>초기 이력서 수정</h2></div>
...
$(document).ready(function(){
	...
	$('#updateResumeBtn').click(function(){
		alert('수정완료');
		$("#updateBasicResumeForm").attr("action", "/resumeupdate.htm").submit();
		
	});	
	
	$('#cancelResumeBtn').click(function(){
		$("#updateBasicResumeForm").attr("action", "/home.htm").submit();
	});	
